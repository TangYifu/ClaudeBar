...
<p align="center">
  <img src="docs/images/notch-collapsed.png" alt="收起态：刘海下方的配额指示线" width="500">
</p>

展开态：鼠标移到刘海下方即展开，显示 5 小时与 7 天配额及重置倒计时。

<p align="center">
  <img src="docs/images/notch-expanded.png" alt="展开态：5 小时与 7 天配额及重置倒计时" width="420">
</p>
...
- 🏝️ **刘海配额岛（可选）**：
  ...
  - **默认关闭**；关闭时不创建任何窗口、不产生额外开销。该设置项仅在检测到刘海的机器上出现，外接显示器不受影响。
