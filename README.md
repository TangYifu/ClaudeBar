...
收起态：刘海下方常驻一条配额指示线，宽度对应 5 小时配额用量。

<p align="center">
  <img src="docs/images/notch-collapsed-v2.png" alt="收起态：刘海下方的配额指示线" width="500">
</p>

展开态：鼠标移到刘海下方即展开，显示 5 小时与 7 天配额及重置倒计时。

<p align="center">
  <img src="docs/images/notch-expanded-v2.png" alt="展开态：5 小时与 7 天配额及重置倒计时" width="420">
</p>
...
- 🏝️ **刘海配额岛（默认开启）**：
  - 在带刘海的 MacBook 上，于刘海下方常驻一条配额指示线，悬停即展开为 5 小时 / 7 天配额与重置倒计时的小面板。
  - 可在设置中关闭；关闭后不创建任何窗口、不产生额外开销。该设置项仅在检测到刘海的机器上出现，外接显示器与无刘海机型不受影响。
  - 窗口尺寸恒定、只对内容做动画，展开收起全程由 Core Animation 在 GPU 上合成。
- 🛡️ **可靠的离线与限流处理**：
...
│   ├── NotchIsland.swift          # 刘海配额岛：几何检测、悬浮窗与展开动画
